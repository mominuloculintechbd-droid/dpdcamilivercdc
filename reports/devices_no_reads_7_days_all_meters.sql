...
where a.measr_comp_type_cd in ('ES-KWH-TOT-1P-DAILY','ES-KWH-TOT-FWD-3P-DAILY','ST-KWH-TOT-1P-DAILY',
'ST-KWH-TOT-FWD-3P-DAILY','WS-KWH-TOT-1P-DAILY','WS-KWH-TOT-FWD-3P-DAILY')
and (trunc(sysdate) - a.most_recent_msrmt_dttm)>15
