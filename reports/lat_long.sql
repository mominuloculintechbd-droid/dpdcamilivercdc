...
(SELECT d.sa_id,d.char_val FROM ci_sa_char d WHERE d.CHAR_TYPE_CD='CM_CUSCA' 
AND d.EFFDT=(SELECT MAX(c1.EFFDT) FROM CI_SA_CHAR C1 WHERE C1.SA_ID=d.SA_ID AND C1.CHAR_TYPE_CD='CM_CUSCA')) TARIFF,
    (
        SELECT
            ci_sa.sa_id,
