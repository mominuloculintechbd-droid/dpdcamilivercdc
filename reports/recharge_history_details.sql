SELECT t2.pay_dt , to_char(t2.CRE_DTTM, 'hh24:mi:ss' )tim,t1.tender_amt ,t3.tndr_source_cd,t4.descr , D.adhoc_Char_val custID,h.id_value MSN,P.CHAR_VAL NOCS, l.descr
...
where T1.PAY_EVENT_ID=T2.PAY_EVENT_ID AND T2.ilm_dt>='15-Dec-2024'  and T2.ilm_dt<='15-Dec-2024' 
